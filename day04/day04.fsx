...
let isBetween (start: int) (finish: int) (v: int) = v >= start && v <= finish
...
let rangesFullyOverLap (a: Range, b: Range) = a.Contains b || b.Contains a

let rangesPartiallyOverlap (a: Range, b: Range) = a.Overlaps b || b.Overlaps a
